...
const GameUI = ({ user, onLogout, onFinish }) => {
  ...
  useEffect(() => {
    if (!canPlay || playCheckLoading) return;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-cyan-900 to-gray-900 p-4 flex items-center justify-center">
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-gray-800 rounded-2xl p-8 border-2 border-red-600">
            <div className="text-6xl mb-6">🚫</div>
            <h1 className="text-4xl font-bold text-red-400 mb-4">Game Already Played</h1>
            <p className="text-xl text-gray-300 mb-6">
              You have already completed the Wisdom Warfare game. Each student can only play once.
            </p>
            <div className="text-lg text-cyan-200 mb-6">
              <p>Check your dashboard to view your final score and ranking.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={onFinish}
  ...
  if (loading || playCheckLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-cyan-900 to-gray-900 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-cyan-400 mx-auto mb-4"></div>
          <h2 className="text-2xl font-bold text-cyan-400 mb-2">
            {playCheckLoading ? 'Checking Play Status...' : 'Connecting to Game...'}
          </h2>
          <p className="text-cyan-200">Please wait while we connect to the game server</p>
        </div>
      </div>
